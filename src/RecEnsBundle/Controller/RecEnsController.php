...
class RecEnsController extends Controller
{
    ...
    {
        $user=$this->getUser();
        $rec= $this->getDoctrine()->getRepository(recens::class)->findBy(['ens'=>$user]);


        return $this->render('@RecEns/Default/Affiche.html.twig', array('c' => $rec,'usr'=>$user));
    }
