...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $matieres = $em->getRepository('SuiviBundle:Matiere')->findAll();
    ...
    {
        $matiere = new Matiere();
        $form = $this->createForm('SuiviBundle\Form\MatiereType', $matiere);
    ...
    {
        $deleteForm = $this->createDeleteForm($matiere);
        $editForm = $this->createForm('SuiviBundle\Form\MatiereType', $matiere);
