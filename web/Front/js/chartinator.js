...
; (function ($, window, document, Math, undefined) {
    ...
    var chartinator = function (el, options) {
        ...
        // Init chart parentEleve
        o.chartParent = false;

        // Init the window width
        o.windowWidth = false;

        // Init chart parentEleve width
        ...
        o.drawChart = function ( ) {
            ...
            google.visualization.events.addListener( o.chart, 'ready', function (e) {
                ...
                // Store the chart parentEleve width
                ...
                'resize': function() {
                    ...
                    o.timer = setTimeout( function() {
                        ...
                        if ( $( window ).width() !== o.windowWidth ) {
                            ...
                            // Test if chart parentEleve has changed width
                            ...
                            } else { // parentEleve has not changed width
