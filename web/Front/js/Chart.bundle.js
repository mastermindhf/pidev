...
function mergeConfigs(parentConfig, childConfig) {
    ...
    for (prop in parentConfig) {
        if (hasOwnProp(parentConfig, prop) &&
            ...
            // make sure changes to properties don't modify parentEleve config
...
module.exports = function(Chart) {
	...
	// @param percentageProperty : property of parentEleve to use when calculating width as a percentage
 ...
 * `element` has a size relative to its parentEleve and this last one is not yet displayed,
 * for example because of `display: none` on a parentEleve node.
...
function addResizeListener(node, listener, chart) {
	...
	// The resizer needs to be attached to the node parentEleve, so we first need to be
